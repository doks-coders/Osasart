...
const Statements = () => {
  return (
    <Box mt={{md:"50px",sm:'100px',base:'100px'}} mb={{md:"100px",sm:'200px',base:'200px'}} minHeight="700px">
        <Container  height="100%" maxW="container.xl"> 
        <Flex  w="100%" flexDirection={'column'} h="100%">
            <Flex h="25%" justifyContent="center" flexDir={'column'} alignItems="center" >
                <Heading textAlign={'center'} fontSize={{sm:'2xl',md:'4xl',base:'2xl'}}>What Our Customers Think</Heading>
                <Box width="24" height="1" bg="black"> </Box>
                 </Flex>
...
let CommentsItems = ()=>{
    let comments = [{comments:'This is one the best services I have recieved, Osasart has yet to disappoint. ',image:'Paw/image.png',name:'Guon Odokuma'},
    ...
    return(
        <>{
            comments.map((val,index)=>(
                <Flex key={index} borderRadius={'10px'} bg="#545871" color="white"  w="100%" py="20px" px={["5px","10px","20px"]} h={"150px"}>
                ...
                <Flex w="75%"  flexDirection="column" justifyContent="space-evenly">
                    <Heading fontWeight={'black'} fontSize={{md:"lg",sm:'sm',base:'sm'}}>{val.name}</Heading>
